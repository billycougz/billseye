...
$(window).click(function(e) {
    if(e.target.innerHTML == '(+) Add New Location' || e.target.innerHTML == '(+) Add New Event' || e.target.innerHTML == '(+) Add New Game' || e.target.innerHTML == '(+) Add New Player' || e.target.id == 'create-group-button' || e.target.id == 'join-group-button' || e.target.id == 'default-group-button'){
        hideModalInputs();
