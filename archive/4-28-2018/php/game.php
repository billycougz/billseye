...
class Game{
	...
	function read(){
	    ...
	    // select all query
	    $query = "
SELECT Game.ID, Game.Date, Game.LocationID, Game.Location, Game.Event, Game.GameNameID, Game.Game, Game.WinnerID, Game.Winner, Loser.LoserID, Loser.Loser
FROM (

SELECT Game.ID, Game.Date, Player.ID AS 'WinnerID', Player.Alias AS  'Winner', Event.Name AS  'Event', Location.ID AS 'LocationID', Location.Name AS  'Location', GameName.ID AS  'GameNameID', GameName.Name AS  'Game'
FROM Game
