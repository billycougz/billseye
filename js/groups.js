...
function createGroupTable(data) {
	groupTable = $('<table id="groupTableID" class="table table-hover"><tr><th>#</th><th>Group </th><th>Primary Location </th><!--<th>Primary Game </th>--><th>Members </th></tr><tbody></tbody></table>');
	for (var i = 0; i < data.length; i++) {
		...
		//$(groupTableRow).append("<td>"+data[i].gameName+"</td>");
		$(groupTableRow).append("<td>"+data[i].members.length+"</td>");
